...
import { elasticQueue } from './elasticQueue.js';
                    ...
                    try {
                        await fetch('https://slack.com/api/chat.postMessage', {
                            ...
                            body: JSON.stringify({
                                ...
                                text: "Kitne post daalega bsdk! Go, touch grass you son-in-law of a beach. limit khatm hogya. Ab ek ghante baad hoga upload tera post. Bhaad me jaa."
                            })
                        });
                        await redisConnection.set(slackSpamKey, 'true', 'EX', 3600);
                    } catch (slackErr) {
